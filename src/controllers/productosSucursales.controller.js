...
/*function agregarProductoSucursal(req, res) {
    ...
    var productosModel = new ProductoSucursal();

    if (parametros.nombreProducto) {
        productosModel.nombreProductoSucursal = parametros.nombreProductoSucursal;
        productosModel.stock = parametros.stock;
        productosModel.cantidadVendida = parametros.cantidadVendida;
        productosModel.idSucursal = parametros.idSucursal;
        productosModel.idEmpresa = parametros.req.user.sub;
